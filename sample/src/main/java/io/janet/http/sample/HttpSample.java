...
import io.janet.http.sample.action.TestProgressAction;
import io.janet.http.sample.action.UsersAction;
import io.janet.http.sample.action.base.BaseAction;
import io.janet.http.sample.util.SampleLoggingService;
...
public class HttpSample {
    ...
    public static void main(String... args) throws NoSuchAlgorithmException, KeyManagementException {
        ...
        usersPipe.createObservable(new UsersAction())
                ...
                .flatMap(state -> Flowable.fromIterable(state.action.getResponse()).take(1))
